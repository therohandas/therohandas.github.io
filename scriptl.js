...
// Create the floating Discord button
const discordButton = document.createElement("a");
discordButton.href = "https://discord.gg/TXqWTKeAAu"; // Replace with your Discord invite link
discordButton.target = "_blank";
discordButton.rel = "noopener noreferrer";
discordButton.className = "floating-discord-button";
...
const NowPlayingfun = (movie) => {
  let url = "./movieDetail?id=" + encodeURIComponent(movie.id);
...
const trendinghtml = function (data) {
  let url = "./movieDetail?id=" + encodeURIComponent(data.id);
  let url2 = "./TvShowsDetails?id=" + encodeURIComponent(data.id);
...
script.async = true;
script.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1157468170597469";
